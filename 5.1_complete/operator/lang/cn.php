...
$jkl['l12'] = "忘记了";
$jkl['l13'] = "密码重设";
$jkl['l14'] = "<h1>您好 %s</h1><p>有人（希望是您！）为您的账户提交了一个忘记密码的请求。如果您不希望更改密码，只需忽略此邮件，什么都不会发生。</p><p>但是，如果您确实忘记了密码并希望设置新密码，请访问以下链接：%s</p><p>此致 %s</p>";
$jkl['l15'] = "新密码";
$jkl['l16'] = "<h1>您好 %s</h1><p>感谢您使用我们的密码恢复功能，您现在可以使用新密码登录：<strong>%s</strong></p><p>如果您有任何问题，请随时通过我们的网站联系我们。</p><p>此致 %s</p>";
$jkl['l17'] = "一个新密码已发送到您的电子邮箱。";
$jkl['l18'] = "注销登录";
$jkl['l19'] = "注销登录成功";
$jkl['l20'] = "您确定要注销登录吗？";
