	...
	<div class="row">
		<div class="col-md-4">
			...
			<div class="form-group">
				...
				<select name="jak_widgetid[]"<?php if (empty($page3)) { ?> multiple="multiple" <?php } ?> data-size="4" data-live-search="true">
...
<div class="card-footer">
	<a href="<?php echo (!empty($page3) ? JAK_rewrite::jakParseurl('bot', 'chatgpt') : JAK_rewrite::jakParseurl('bot'));?>" class="btn btn-default"><?php echo $jkl["g103"];?></a>
